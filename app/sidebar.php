 ...
 * En caso de usar widgets, descomenta en 'functions.php#L37' para habilitar las
 * posiciones.
 */
 ...
 * ve al archivo donde quieres agregar los widgets y añade el siguiente código
 * php: get_sidebar( 'sidebar-ID' );
 *
